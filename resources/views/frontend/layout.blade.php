                ...
                <div class="container-fluid">
                    <div class="header-bottom-wrapper">
                        ...
                        <div class="menu-style-2 furniture-menu menu-hover">
                            <nav>
                                <ul>
                                    <li><a style="font-size:2rem;" href="/">home</a>
                                    </li>
                                    <li><a style="font-size:2rem;" href="{{ url('products') }}">pages</a>
                                    ...
                                    <li><a style="font-size:2rem;" href="{{ url('products') }}">shop</a>
                                        
                                    <li><a style="font-size:2rem;" href="blog.html">blog</a>
                                        <ul class="single-dropdown">
                                    ...
                                    <li><a style="font-size:2rem;" href="contact.html">contact</a></li>
                                </ul>
                            </nav>
                        </div>
                ...
                <div class="services-wrapper">
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            <h4>Gratis Ongkir</h4>
                            <p>Dimana Pun anda berada Semua product gratis ongkos kirim loh!!!</p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            <h4>Terpercaya</h4>
                            <p>Ecpmmerce ini sudah diakui oleh banyak orang</p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            ...
                            <p>Jangan takut jika anda melakukan pembayaran </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget-wrapper">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-about-2">
                                <p>Elctronet adalah sebuah platform e-commerce yang spesialis dalam menyediakan<br> berbagai macam produk elektronik. Sebagai tujuan utama, Electronet ingin<br>
                                     memberikan pengalaman belanja elektronik yang menyenangkan dan nyaman bagi pelanggan mereka.</p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Sitoluama <br>Institut Teknologi Del</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> dianmanurung132@gmail.com</a> <br><a href="#">manroexft@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
